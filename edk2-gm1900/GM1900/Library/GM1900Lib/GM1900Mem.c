...
#define SM8150_PERIPH_BASE              0x00000000
#define SM8150_PERIPH_SZ                0x80000000
...
STATIC struct reservedmemory {
    ...
    { 0x85e00000, 0x00140000 },    // xbl_region
    ...
    { 0x98800000, 0x00100000 },    // pil_spss_region
    { 0x9c000000, 0x02400000 },    // cont_splash_region (framebuffer)
...
ArmPlatformGetVirtualMemoryMap (
    ...
    // SM8150 SOC peripherals
    VirtualMemoryTable[++Index].PhysicalBase  = SM8150_PERIPH_BASE;
    VirtualMemoryTable[Index].VirtualBase     = SM8150_PERIPH_BASE;
    VirtualMemoryTable[Index].Length          = SM8150_PERIPH_SZ;
